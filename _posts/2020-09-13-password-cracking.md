...
one can visualize some image and describe that it with at least 4 words.
...
our mobile devices (phones, AppleWatch) such as
[Authy](https://authy.com), [Google Autheticator](https://en.wikipedia.org/wiki/Google_Authenticator)
